...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OneLoginApi.GetRiskScoreRequest();
  });
  ...
  describe('GetRiskScoreRequest', function() {
    it('should create an instance of GetRiskScoreRequest', function() {
      // uncomment below and update the code to test GetRiskScoreRequest
      //var instance = new OneLoginApi.GetRiskScoreRequest();
      //expect(instance).to.be.a(OneLoginApi.GetRiskScoreRequest);
    });
