...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OneLoginApi.AddClientAppRequest();
  });
  ...
  describe('AddClientAppRequest', function() {
    it('should create an instance of AddClientAppRequest', function() {
      // uncomment below and update the code to test AddClientAppRequest
      //var instance = new OneLoginApi.AddClientAppRequest();
      //expect(instance).to.be.a(OneLoginApi.AddClientAppRequest);
    });
